...
/**
 * Copy from v1.3.1. Starting with 1.4.0-alpha05, single-finger dragging is possible, causing transformable and detectDragGestures to conflict
 *
 ...
 */
fun Modifier.transformableTwoDowns(
