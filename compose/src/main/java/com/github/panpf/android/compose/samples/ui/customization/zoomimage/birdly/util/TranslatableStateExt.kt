package com.github.panpf.android.compose.samples.ui.customization.zoomimage.birdly.util
...
suspend fun TransformableState.animateZoomBy(
    previousZoomState: BirdlyZoomableState,
    scale: Float,
    touchPoint: Offset,
    size: IntSize,
...
suspend fun TransformableState.animateZoomBy(
    previousZoomState: BirdlyZoomableState,
    nextZoomState: BirdlyZoomableState,
