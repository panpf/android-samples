package com.github.panpf.android.compose.samples.ui.customization.zoomimage.birdly
...
import com.github.panpf.android.compose.samples.ui.customization.zoomimage.birdly.gesture.tap.TapHandler
import com.github.panpf.android.compose.samples.ui.customization.zoomimage.birdly.gesture.transform.TransformGestureHandler

fun Modifier.birdlyZoomable(
    ...
    then(
        Modifier.birdlyZoomable(
            rememberMutableBirdlyZoomState(),
            zoomRange,
            zoomingZIndex,
            defaultZIndex,
            tapHandler,
...
fun Modifier.birdlyZoomable(
    zoomState: MutableBirdlyZoomState,
    zoomRange: ClosedFloatingPointRange<Float> = 1f..3f,
    zoomingZIndex: Float = 1f,
    defaultZIndex: Float = 0f,
    tapHandler: TapHandler = TapHandler(),
