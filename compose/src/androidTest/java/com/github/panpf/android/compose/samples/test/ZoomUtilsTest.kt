...
import com.github.panpf.android.compose.samples.ui.customization.zoomimage.my.Edge
...
import com.github.panpf.android.compose.samples.ui.customization.zoomimage.my.computeScrollEdge
...
//            }
    ...
    fun testComputeScrollEdge() {
        ...
        listOf(
            (Rect(0f, 0f, 1000f, 1000f) to true) to Edge.BOTH,
            (Rect(0f, 0f, 1000f, 1000f) to false) to Edge.BOTH,

            (Rect(0f, 0f, 500f, 500f) to true) to Edge.START,
            (Rect(0f, 0f, 500f, 500f) to false) to Edge.START,
            (Rect(200f, 0f, 800f, 500f) to true) to Edge.NONE,
            (Rect(200f, 0f, 800f, 500f) to false) to Edge.START,
            (Rect(500f, 0f, 1000f, 1000f) to true) to Edge.END,
            (Rect(500f, 0f, 1000f, 500f) to false) to Edge.START,

            (Rect(0f, 200f, 500f, 800f) to true) to Edge.START,
            (Rect(0f, 200f, 500f, 800f) to false) to Edge.NONE,
            (Rect(200f, 200f, 800f, 800f) to true) to Edge.NONE,
            (Rect(200f, 200f, 800f, 800f) to false) to Edge.NONE,
            (Rect(500f, 200f, 1000f, 800f) to true) to Edge.END,
            (Rect(500f, 200f, 1000f, 800f) to false) to Edge.NONE,

            (Rect(0f, 500f, 500f, 1000f) to true) to Edge.START,
            (Rect(0f, 500f, 500f, 1000f) to false) to Edge.END,
            (Rect(200f, 500f, 800f, 1000f) to true) to Edge.NONE,
            (Rect(200f, 500f, 800f, 1000f) to false) to Edge.END,
            (Rect(500f, 500f, 1000f, 1000f) to true) to Edge.END,
            (Rect(500f, 500f, 1000f, 1000f) to false) to Edge.END,
        ).forEach {
