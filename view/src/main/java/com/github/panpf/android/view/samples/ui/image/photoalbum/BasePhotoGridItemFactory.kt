...
import com.github.panpf.android.view.samples.databinding.PhotoItemBinding
...
abstract class BasePhotoGridItemFactory :
    ...
    final override fun createItemViewBinding(
        ...
        if (itemSize == null && parent is RecyclerView) {
            ...
            val gridDivider = context.resources.getDimensionPixelSize(com.github.panpf.android.samples.common.R.dimen.grid_divider)
